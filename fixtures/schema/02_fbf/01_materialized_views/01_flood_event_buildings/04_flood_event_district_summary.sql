--
-- Name: mv_hazard_event_district_summary; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
DROP MATERIALIZED VIEW IF EXISTS public.mv_hazard_event_district_summary;
CREATE MATERIALIZED VIEW public.mv_hazard_event_district_summary AS
