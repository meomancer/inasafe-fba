--
-- Name: mv_hazard_event_sub_district_summary; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
DROP MATERIALIZED VIEW IF EXISTS public.mv_hazard_event_sub_district_summary;
CREATE MATERIALIZED VIEW public.mv_hazard_event_sub_district_summary AS
 WITH non_hazarded_count_selection AS (
         ...
         SELECT a.hazard_event_id,
          ...
          GROUP BY a.district_id, a.sub_district_id, a.hazard_event_id
         ...
         SELECT a.hazard_event_id,
           ...
           FROM ((hazarded_count_selection a
             JOIN non_hazarded_count_selection b_1 ON (((a.district_id = b_1.district_id) AND (a.sub_district_id = b_1.sub_district_id))))
 ...
 SELECT hazarded_aggregate_count.hazard_event_id,
   ...
   FROM (hazarded_aggregate_count
     LEFT JOIN public.sub_district_trigger_status b ON (((b.sub_district_id = (hazarded_aggregate_count.sub_district_id)::double precision) AND (hazarded_aggregate_count.hazard_event_id = b.hazard_event_id))))
  WITH NO DATA;
