DROP MATERIALIZED VIEW IF EXISTS public.mv_hazard_event_road_sub_district_summary;
CREATE MATERIALIZED VIEW public.mv_hazard_event_road_sub_district_summary AS
