...
cp -rn ${FIXTURES_PATH}/tests/docker-osm/clip.grenada.geojson docker-osm-settings/custom_settings/clip.geojson

# Download test pbf for docker-osm
export PBF_URL=https://download.geofabrik.de/central-america-latest.osm.pbf
