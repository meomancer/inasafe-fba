...
if __name__ == '__main__':
    ...
    with runner.session() as s:
        ...
        response = runner.assert_get(
            s,
            '/workspaces/kartoza/datastores/gis/featuretypes/hazard_map_sub_district')
        ...
        data = {
            'featureType': {
                ...
                'nativeName': 'hazard_map_sub_district',
                'title': 'hazard_map_sub_district',
                'srs': 'EPSG:4326',
                'metadata': {
                    'entry': [
                        {
                            ...
                            'virtualTable': {
                                ...
                                b.geom 
                                from 
                                mv_hazard_event_sub_district_summary a 
