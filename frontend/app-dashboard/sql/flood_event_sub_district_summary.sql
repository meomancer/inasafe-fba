...
--   Make a table that aggregates sub district hazarded building counts
...
--  aggregate by sub district and hazard_event_id
         group by district_id, sub_district_id, hazard_event_id
     ),
